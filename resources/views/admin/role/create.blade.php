            ...
            <div class="row">
                <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                    <div class="widget am-cf">
                        <form id="my-form" class="am-form tpl-form-line-form" action="{{ url('/admin/role') }}"
                                ...
                                <fieldset>
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9 am-u-end">
                                            <input type="text" class="tpl-form-input" name="Role[name]" value=""
                                                                    ...
                                                                    <div class="am-checkbox">
                                                                        <label>
                                                                            <input name="power_id[]"
                                                                                   ...
                                                                                   value="{{ $menu->id }}"
                                                                                   type="checkbox"> {{ $menu->getShrotName() }}
                                                                        </label>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                                            ...
                                                                            <div class="am-checkbox-inline am-margin-left-lg">
                                                                                <label>
                                                                                    <input name="power_id[]"
                                                                                           ...
                                                                                           value="{{ $two->id }}"
                                                                                           type="checkbox"> {{ $two->getShrotName() }}
                                                                                </label>
                                                                            </div>
                                                                        </td>
                                                                        <td class="am-text-left">
                                                                                    ...
                                                                                    <div class="am-checkbox-inline">
                                                                                        <label>
                                                                                            <input name="power_id[]"
                                                                                                   ...
                                                                                                   value="{{ $three->id }}"
                                                                                                   type="checkbox"> {{ $three->getShrotName() }}
                                                                                        </label>
                                                                                    </div>
                                                                                @endif
                                                                            @endforeach
