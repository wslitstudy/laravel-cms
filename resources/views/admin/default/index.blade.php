            ...
            <div class="row">
                <div class="am-u-sm-12 am-u-md-12 am-u-lg-12 am-margin-bottom">
                    <div class="widget am-cf">
                        ...
                        <div class="widget-body am-cf">
                            <div id="echarts-trade" class="widget-echarts" _echarts_instance_="ec_1540387818301"
                                 style="-webkit-tap-highlight-color: transparent; user-select: none; position: relative; background: rgba(252, 252, 252, 0);">
                                <div style="position: relative; overflow: hidden; width: 1204px; height: 400px;">
                                    <canvas width="2408" height="800" data-zr-dom-id="zr_0"
                                            style="position: absolute; left: 0px; top: 0px; width: 1204px; height: 400px; user-select: none; -webkit-tap-highlight-color: rgba(0, 0, 0, 0);"></canvas>
                                </div>
                                <div></div>
                            </div>
                        </div>
        ...
        <script type="text/javascript">
            ...
            echarts.init(dom, 'walden').setOption({
                ...
                xAxis: {
                    type: 'category',
                    boundaryGap: false,
                    data: ["2018-10-18", "2018-10-19", "2018-10-20", "2018-10-21", "2018-10-22", "2018-10-23", "2018-10-24"]
                },
                yAxis: {
                    type: 'value'
                },
