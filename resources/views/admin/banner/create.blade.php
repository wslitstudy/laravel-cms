            ...
            <div class="row">
                <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                    <div class="widget am-cf">
                        <form id="my-form" class="am-form tpl-form-line-form" action="{{ url('/admin/banner') }}"
                            ...
                            <div class="widget-body">
                                <fieldset>
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9 am-u-end">
                                            <input type="text" class="tpl-form-input" name="Banner[url]" value=""
                                                   placeholder="请输入链接地址">
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9 am-u-end">
                                            <input type="number" class="tpl-form-input" name="Banner[sort]" value="1"
                                            ...
                                            @foreach($data['status_label'] as $key=>$value)
                                                <label class="am-radio-inline">
                                                    <input type="radio" value="{{ $key }}"
                                                           name="Banner[is_show]" {{ $key == 1 ? 'checked' : '' }}> {{ $value }}
                                                </label>
                                            @endforeach
                                        </div>
                                    </div>
