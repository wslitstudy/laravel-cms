            ...
            <div class="row">
                <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                    <div class="widget am-cf">
                        <form id="my-form" class="am-form tpl-form-line-form" action="{{ url('/admin/article') }}"
                                ...
                                <fieldset>
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9 am-u-end">
                                            <input type="text" class="tpl-form-input" name="Article[title]" value=""
                                        ...
                                        <div class="am-u-sm-9 am-u-end">
                                            <select name="Article[cate_id]" data-am-selected="{btnSize: 'sm', placeholder: '请选择文章分类'}" required>
                                                ...
                                                @foreach($data['category'] as $cateId=>$name)
                                                    <option value="{{ $cateId }}">{{ $name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9 am-u-end">
                                            <input type="number" class="tpl-form-input" name="Article[sort]" value="1"
                                            ...
                                            @foreach($data['status_label'] as $key=>$value)
                                                <label class="am-radio-inline">
                                                    <input type="radio" value="{{ $key }}"
                                                           name="Article[is_show]" {{ $key == 1 ? 'checked' : '' }}> {{ $value }}
                                                </label>
                                            @endforeach
                                        </div>
                                    </div>
