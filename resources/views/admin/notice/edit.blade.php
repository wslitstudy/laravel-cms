            ...
            <div class="row">
                <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                    <div class="widget am-cf">
                        <form id="my-form" class="am-form tpl-form-line-form" action="/admin/notice/{{ $data['info']->id }}"
                                ...
                                <fieldset>
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9 am-u-end">
                                            <input type="text" class="tpl-form-input" name="Notice[title]" value="{{ $data['info']->title }}"
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9 am-u-end">
                                            <input type="number" class="tpl-form-input" name="Notice[sort]" value="{{ $data['info']->sort }}"
                                            ...
                                            @foreach($data['status_label'] as $key=>$value)
                                                <label class="am-radio-inline">
                                                    <input type="radio" value="{{ $key }}"
                                                           name="Notice[is_show]" {{ $key == $data['info']->is_show ? 'checked' : '' }}> {{ $value }}
                                                </label>
                                            @endforeach
                                        </div>
                                    </div>
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9 am-u-end">
                                            <textarea id="container" name="Notice[content]" type="text/plain">{{ $data['info']->content }}</textarea>
                                        </div>
                                    </div>
                                    <div class="am-form-group">
